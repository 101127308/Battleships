...
namespace CodeConversion
{
    ...
    /// </summary>
        ...
        //int ISeaGrid.Width { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        //int ISeaGrid.Height { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        //TileView ISeaGrid.Item { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
